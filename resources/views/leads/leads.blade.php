        ...
        <div class="white-box">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <input type="date" name="" id="" class="form-control" placeholder="mm/dd/yyyy">
                    </div>
                    <div class="col-md-6">
                      <input type="date" name="" id="" class="form-control" placeholder="mm/dd/yyyy">
                    </div>
          ...
          <div class="table-responsive">
            <div id="myTable_wrapper" class="dataTables_wrapper no-footer">
              <table id="myTable" class="table table-bordered table-stribed table-hover manage-u-table dataTable no-footer" role="grid" aria-describedby="myTable_info">
                <thead>
                  <tr role="row">
                    <th class="sorting_asc" tabindex="0" aria-controls="myTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 262px;">
                      Lead</th>
                    ...
                    <th class="sorting" tabindex="0" aria-controls="myTable" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending" style="width: 110px;">
                      Submitted on</th>
                    ...
                    <td class="sorting_1">
                      <div class="flex-column">
                        ...
                        <span class="text-right">
                          ...
                          <a href="tel:{{$lead->phone}}" class="btn btn-success lead-btn" title="{{$lead->phone}}"><i class="fa  fa-phone"></i></a>
                        </span>
                      </div>
                    </td>
                    <td>{{$lead->title}}</td>
