                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <input type="date" name="min_date" id="" class="form-control"
                                                ...
                                                value="@if(isset($_GET['min_date'])){{$_GET['min_date']}}@endif">
                                        </div>
                                        <div class="col-md-6">
                                            <input type="date" name="max_date" id="" class="form-control"
                                                placeholder="mm/dd/yyyy"
                                                value="@if(isset($_GET['max_date'])){{$_GET['max_date']}}@endif">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <select class="form-control" id="assigned" name="user_id">
                                                ...
                                                @if(get_role(session('workplace')->id) <= 2 || Auth::user()->id ==
                                                    ...
                                                    <option value="{{$user->user->id}}" @if(isset($_GET['user_id']) &&
                                                        $_GET['user_id']==$user->user->id) selected
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="product_id" id="assigned">
                                                ...
                                                @if (get_role(session('workplace')->id) <= 1 ||
                                                    (get_role(session('workplace')->id) > 1 &&
                                                    in_array(Auth::user()->id,$value->selected_ids)))
                                                    <option value="{{$value->id}}" @if(isset($_GET['product_id']) &&
                                                        $_GET['product_id']==$value->id) selected
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="status" id="lead-quality">
                                                ...
                                                <option value="0" @if(isset($_GET['status']) && $_GET['status']==0)
                                                    selected @endif>Qualified</option>
                                                <option value="1" @if(isset($_GET['status']) && $_GET['status']==1)
                                                    selected @endif>Un Qualified</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="myTable" rowspan="1" colspan="1"
                                            ...
                                            style="width: 389px;">Workplace</th>
                                        <th class="sorting" tabindex="0" aria-controls="myTable" rowspan="1" colspan="1"
                                            aria-label="Position: activate to sort column ascending"
                                        ...
                                        <td class="sorting_1">
                                            <div class="flex-column">
                                                ...
                                                <span class="text-right">
                                                    ...
                                                    <a href="tel:{{$lead->phone}}" class="btn btn-success lead-btn"
                                                        title="{{$lead->phone}}"><i class="fa  fa-phone"></i></a>
                                                </span>
                                            </div>
                                        </td>
                                        <td>@if(@$lead->workplaces[0]){{$lead->workplaces[0]->title}}@else - @endif</td>
                                        <td>@if($lead->product){{$lead->product->title}}@else - @endif</td>
                                        <td><span
                                                class="badge badge-primary">@if($lead->source){{$lead->source->name}}@else
                                                - @endif</span></td>
