                                ...
                                <form action="#" method="post">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label class="control-label">Count of Users</label>
                                                    <select class="form-control" name="select_users">
                                                        <option value=">" @if(@$select_users && $select_users == '>') selected @endif>More Than</option>
                                                        <option value="<" @if(@$select_users && $select_users == '<') selected @endif>Less Than</option>
                                                    </select> <span class="help-block"> Select your Filter </span></div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label class="control-label"></label>
                                                    <input type="number" class="form-control" min="1" placeholder="Count" name="count_users" value="@if(@$count_users){{$count_users}}@endif">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                        ...
                        <div class="panel">
                            <div class="row panel-heading">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-6 text-right">
                                    ...
                                    {{--                                    <a href="{{url('admin/Workplaces/create')}}" class="btn btn-primary m-t-20">Add User</a>--}}
                                    {{--@endif--}}
                                </div>
                            </div>
