    ...
    <div class="container-fluid">
        <div class="row bg-title">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                ...
                <ol class="breadcrumb">
                    <li><a href="{{url('user_workplaces')}}">Workplaces</a></li>
        ...
        <div class="row">
            <div class="col-sm-12">
                    ...
                    <div class="row row-in">
                        <div class="col-lg-6 col-sm-6 row-in-br">
                            <ul class="col-in">
                                ...
                                <li class="col-last">
                                    <h3 class="counter text-right m-t-15">{{$user_workplaces_count}}</h3>
                                </li>
                                <li class="col-middle">
                                    <h4>My Workplaces</h4>
                                    {{-- <div class="progress">
                                        <div class="progress-bar progress-bar-danger" role="progressbar"
                                            aria-valuenow="{{$user_workplaces}}" aria-valuemin="0" aria-valuemax="100"
                                    style="width: {{$user_workplaces}}%">
                                    <span class="sr-only">{{$user_workplaces}}% Complete (success)</span>
                        </div>
                    </div> --}}

                    </li>
                    <div class="row">
                        @if($user_workplaces_count>0)
                        <div class="col-md-6 col-sm-6 col-xs-6 text-center">
                            <a href="{{url('user_workplaces')}}" class="btn btn-primary m-t-20">View Workplaces</a>
                        </div>
                        @endif
                        <div class="col-md-6 col-sm-6 col-xs-6 text-center">
                            <a href="{{url('workplace/create')}}" class="btn btn-info m-t-20">Create New Workspace</a>
                        </div>
                    </div>
                    </ul>
                </div>
                <div class="col-lg-6 col-sm-6 row-in-br">
                    <ul class="col-in">
                        ...
                        <li class="col-last">
                            <h3 class="counter text-right m-t-15">{{$invited_workplaces_count}}</h3>
                        </li>
                        <li class="col-middle">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                    @if($invited_workplaces_count>0)
                    <a href="{{url('invited_workplaces')}}" class="btn btn-primary m-t-20">View Workplaces</a>
                    @endif
                </div>
            </div>
            </ul>
                            ...
                            <div class="col-sm-6">
                                <ul class="side-icon-text pull-right">
                                    <li><a href="#"><span class="circle circle-sm bg-success di"><i
                                                    class="ti-plus"></i></span><span>Add Users</span></a></li>
                                    <li><a href="#"><span class="circle circle-sm bg-danger di"><i
                                                    class="ti-pencil-alt"></i></span><span>Edit</span></a></li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    <tr class="advance-table-row active">
                                        ...
                                        <td style="width: 60px;"><img src="../plugins/images/users/varun.jpg"
                                                class="img-circle" width="30" alt="user img" /></td>
                                        <td>Andrew Simons</td>
                                        <td>Modulator</td>
                                        <td>6 May 2016</td>
                                        <td>Gujrat, India</td>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr class="advance-table-row">
                                        ...
                                        <td style="width: 60px;"><img src="../plugins/images/users/varun.jpg"
                                                alt="user img" class="img-circle" width="30" /></td>
                                        <td>Andrew Simons</td>
                                        <td>Modulator</td>
                                        <td>6 May 2016</td>
                                        <td>Gujrat, India</td>
            ...
            <div class="panel-body">
                <ul class="side-icon-text">
                    <li class="m-0"><a href="#"><span class="circle circle-md bg-success di vm"><i
                            ...
                            <div class="di vm">
                                <h1 class="m-b-0">$458.50</h1>
                                <h5 class="m-t-0">Your wallet Banalce</h5>
                            </div>
                        </a></li>
                </ul>
            </div>
        ...
        <div class="panel">
            <div class="p-30">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-8">
                        ...
                        <h4>UIUX Designer</h4><a href="javascript:void(0)" class="btn btn-rounded btn-success"><i
                                class="ti-plus m-r-5"></i> FOLLOW</a>
                    </div>
                </div>
            ...
            <div class="p-20 text-center">
                ...
                <ul class="dp-table m-t-30">
                    <li><img src="../plugins/images/users/varun.jpg" alt="varun" width="60" data-toggle="tooltip"
                            title="Varun Dhavan" class="img-circle"></li>
                    <li><img src="../plugins/images/users/genu.jpg" alt="varun" width="60" data-toggle="tooltip"
                            title="Varun Dhavan" class="img-circle"></li>
                    <li><img src="../plugins/images/users/pawandeep.jpg" alt="varun" width="60" data-toggle="tooltip"
                            title="Varun Dhavan" class="img-circle"></li>
        ...
        <div class="panel panel-themecolor">
            ...
            <div class="panel-body">
                <div class="steamline">
                    ...
                    <div class="sl-item">
                        <div class="sl-left"> <img class="img-circle" alt="user" src="../plugins/images/users/sonu.jpg">
                        </div>
                        <div class="sl-right">
                        ...
                        <div class="sl-right">
                            ...
                            <div class="desc">The generated lorem ipsum
                                <br><a href="javascript:void(0)"
                                    class="btn m-t-10 m-r-5 btn-rounded btn-outline btn-success">Apporve</a> <a
    ...
    <div class="col-lg-4 col-md-12 col-sm-12">
        <div class="panel panel-themecolor">
            <div class="panel-heading"> CHATBOX
                <div class="pull-right"> <a href="#" data-perform="panel-dismiss"><i class="ti-close"></i></a>
                </div>
            </div>
                ...
                <div class="panel-body">
                    <div class="chat-box" style="height: 510px;">
                        <ul class="chat-list slimscroll" style="overflow: hidden;" tabindex="5005">
                            <li>
                                <div class="chat-image"> <img alt="male" src="../plugins/images/users/sonu.jpg">
                                </div>
                                <div class="chat-body">
                                    <div class="chat-text">
                                        <h4>Sonu Nigam</h4>
                            ...
                            <li class="odd">
                                <div class="chat-image"> <img alt="Female" src="../plugins/images/users/genu.jpg">
                                </div>
                                <div class="chat-body">
                                    <div class="chat-text">
                                        <h4>Genelia</h4>
