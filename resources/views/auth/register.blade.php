                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="@if(isset($email)){{$email}}@else{{ old('email') }}@endif" required autocomplete="email">
                ...
                <div class="white-box">
                    ...
                    <div class="form-group m-b-0">
                      <div class="col-sm-12 text-center">
                        <p>have an account? <a href="{{ url('/') }}" class="text-primary m-l-5"><b>Login</b></a></p>
                      </div>
                    </div>
                  </form>
                </div>
