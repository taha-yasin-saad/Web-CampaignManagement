                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input required type="text" class="form-control" placeholder="Widget #1"
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Type</label>
                                                <select class="form-control" name="widget_type" id="widget_type"  required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="radio" name="icon_type" value="mdi-phone">
                                                        <li class="mdi mdi-phone fa-fw" style="font-size:30px"></li>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <input type="radio" name="icon_type" value="mdi-cellphone-android">
                                                        <li class="mdi mdi-cellphone-android fa-fw"
                                                            style="font-size:30px"></li>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <input type="radio" name="icon_type" value="mdi-headset">
                                            ...
                                            <div class="button-review">
                                                <div class="button-circle">
                                                    <div class="buttonround" title="Chat now">
                                                        <li class="mdi mdi-phone fa-fw x-icon" style=""></li>
                                                        <div class="buttonround_tooltip">
															<p>Want to talk to an expert?</p>
															<p>Our Team is 60 Second Away From You!</p>
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-3">
                                                <input class="d-inline" type="checkbox"><span> Custom Field
                                                    01</span><br>
                                            </div>
                                            <div class="col-md-3">
                                                <input class="d-inline" type="checkbox"><span> Custom Field
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text"
                                                    placeholder="Talk to expert now!">
                                            </div>
                                            <div class="form-group">
