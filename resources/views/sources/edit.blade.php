                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-3">
                                                <input class="d-inline" name="fields[]" type="checkbox" value="name" @if(isset($data) && in_array("name", $data->fields)) checked @endif><span> Name</span><br>
                                            </div>
                                            <div class="col-md-3">
                                                <input class="d-inline" name="fields[]" type="checkbox" value="email" @if(isset($data) && in_array("email", $data->fields)) checked @endif><span> Email</span><br>
                                            </div>
                                            <div class="col-md-3">
                                                <input class="d-inline" name="fields[]" type="checkbox" value="custom1" @if(isset($data) && in_array("custom1", $data->fields)) checked @endif><span> Custom Field
                                                    01</span><br>
                                            </div>
                                            <div class="col-md-3">
                                                <input class="d-inline" name="fields[]"  type="checkbox" value="custom2" @if(isset($data) && in_array("custom1", $data->custom2)) checked @endif><span> Custom Field
                                                    02</span><br>
                                            </div>
                                            <div class="form-group">
